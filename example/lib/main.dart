...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    try {
      try {
        isUsbDebugging = await FlutterDebuggingPlugin.isUsbDebuggingEnabled;
      } catch (e, s) {
        printLog(e.toString() + s.toString());
      }
      try {
        isVpnConnected = await FlutterDebuggingPlugin.isVpnConnected;
      } catch (e, s) {
        printLog(e.toString() + s.toString());
      }
      try {
        isDeviceRooted = await FlutterDebuggingPlugin.isDeviceRooted;
      } catch (e, s) {
        printLog(e.toString() + s.toString());
      }
